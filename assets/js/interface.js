var minersAddr = '0x92eeb38e8CbC5bC331541b0fC1A84e9C1aB2366f';
var tokenAddr = '0xD4d55B811d9eDe2aDce61a98d67d7f91bFfcE495';
var minersAbi =
[
	{
		"constant": true,
...
function buyEggs(ref, trx, callback){
	if(+trx > +usrBal) {
		alert("You don't have " + trx + " PulseDoge in your wallet");
	}
	else if(+trx > +spend) {
		alert("Approve spending " + "PulseDoge" + " first");
	} else {
